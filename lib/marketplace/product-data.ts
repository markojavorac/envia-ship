...
const PRODUCT_TEMPLATES = {
  [ProductCategory.FOOD_BEVERAGES]: [
    ...
    },
    {
      ...
      weightRange: [0.5, 1.2],
      dims: [12, 12, 15],
      tags: ["organic", "local", "pure"],
    },
    {
      name: "Freshly Roasted Chicken",
      priceRange: [70, 130],
      weightRange: [1.5, 3],
      dims: [25, 20, 15],
      tags: ["fresh", "ready-to-eat", "hot"],
    },
    {
  ...
  [ProductCategory.PHARMACY_MEDICAL]: [
    {
      ...
      weightRange: [1, 2],
      dims: [25, 20, 15],
      tags: ["essential", "certified", "complete"],
    },
    {
    ...
    },
    {
      ...
      weightRange: [0.2, 0.4],
      dims: [15, 10, 5],
      tags: ["medical-grade", "digital", "accurate"],
    },
    {
      ...
      weightRange: [0.8, 1.5],
      dims: [20, 18, 10],
      tags: ["medical-grade", "home-use", "certified"],
    },
    {
      ...
      weightRange: [0.1, 0.3],
      dims: [10, 8, 3],
      tags: ["certified", "effective", "trusted"],
    },
    {
      name: "Surgical Face Masks Box",
      priceRange: [35, 70],
      weightRange: [0.3, 0.6],
      dims: [15, 12, 8],
      tags: ["certified", "protective", "disposable"],
    },
    {
      ...
      weightRange: [0.5, 1.2],
      dims: [20, 15, 10],
      tags: ["antibacterial", "certified", "safe"],
    },
    {
      name: "Wound Care Kit",
      priceRange: [60, 130],
      weightRange: [0.4, 0.9],
      dims: [18, 15, 8],
      tags: ["complete", "sterile", "certified"],
    },
    {
      ...
      weightRange: [0.2, 0.5],
      dims: [12, 10, 8],
      tags: ["effective", "certified", "fast-acting"],
    },
    {
      ...
      weightRange: [1, 2.5],
      dims: [30, 25, 20],
      tags: ["gentle", "certified", "complete"],
    },
    {
      ...
      weightRange: [0.3, 0.7],
      dims: [10, 10, 12],
      tags: ["certified", "essential", "trusted"],
    },
    {
      ...
      weightRange: [0.5, 1],
      dims: [20, 15, 10],
      tags: ["medical-grade", "accurate", "certified"],
    },
    {
      ...
      weightRange: [0.2, 0.5],
      dims: [15, 8, 5],
      tags: ["effective", "fast-acting", "certified"],
    },
    {
      name: "Immune Booster Supplement",
      priceRange: [75, 145],
      weightRange: [0.3, 0.7],
      dims: [10, 10, 15],
      tags: ["natural", "certified", "effective"],
    },
    {
      name: "Pulse Oximeter",
      priceRange: [120, 250],
      weightRange: [0.1, 0.3],
      dims: [10, 8, 5],
      tags: ["medical-grade", "accurate", "portable"],
    },
  ],
  [ProductCategory.GENERAL_RETAIL]: [
    {
      ...
      weightRange: [0.5, 1.5],
      dims: [15, 15, 15],
      tags: ["wireless", "portable", "quality-sound"],
    },
    {
      ...
      weightRange: [0.5, 1],
      dims: [25, 15, 10],
      tags: ["office", "organization", "modern"],
    },
    {
      ...
      weightRange: [0.6, 1.2],
      dims: [20, 20, 40],
      tags: ["energy-efficient", "adjustable", "modern"],
    },
    {
    ...
    },
    {
      ...
      weightRange: [0.8, 1.5],
      dims: [40, 20, 5],
      tags: ["wireless", "ergonomic", "quality"],
    },
    {
      ...
      weightRange: [0.4, 0.9],
      dims: [25, 10, 10],
      tags: ["eco-friendly", "reusable", "durable"],
    },
    {
      ...
      weightRange: [0.5, 1],
      dims: [25, 20, 3],
      tags: ["quality-paper", "professional", "elegant"],
    },
    {
      ...
      weightRange: [0.8, 1.8],
      dims: [40, 30, 15],
      tags: ["durable", "spacious", "comfortable"],
    },
    {
    ...
    },
    {
      ...
      weightRange: [1, 2.5],
      dims: [70, 15, 15],
      tags: ["fitness", "non-slip", "portable"],
    },
    {
    ...
    },
    {
      ...
      weightRange: [0.5, 1.2],
      dims: [20, 20, 10],
      tags: ["portable", "rechargeable", "quiet"],
    },
  ],
};
    ...
    for (let i = 0; i < numProducts; i++) {
      ...
      products.push({
        ...
        name:
          i < templates.length
            ? template.name
            : `${template.name} ${String.fromCharCode(65 + Math.floor(i / templates.length))}`,
