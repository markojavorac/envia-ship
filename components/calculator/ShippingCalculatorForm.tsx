...
export default function ShippingCalculatorForm({
  ...
  return (
    <div className="space-y-4">
      {/* Form Section */}
      <Card className="border-border bg-card border-2 shadow-lg">
        ...
        <CardContent className="p-4 pt-4">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Card className="border-primary/30 bg-card border-2">
              ...
              <CardContent className="p-4 pt-0">
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    <Label htmlFor="length" className="text-foreground text-xs font-semibold">
                      L (cm)
                    </Label>
                    <Input
                      id="length"
                  ...
                  <div>
                    <Label htmlFor="width" className="text-foreground text-xs font-semibold">
                      W (cm)
                    </Label>
                    <Input
                      id="width"
                  ...
                  <div>
                    <Label htmlFor="height" className="text-foreground text-xs font-semibold">
                      H (cm)
                    </Label>
                    <Input
                      id="height"
                ...
                <div className="mt-3">
                  <Label htmlFor="weight" className="text-foreground text-xs font-semibold">
                    Weight (kg)
                  </Label>
                  <Input
                    id="weight"
            ...
            <Card className="border-primary/30 bg-card border-2">
              ...
              <CardContent className="space-y-3 p-4 pt-0">
                <div className="space-y-2">
                  <Label htmlFor="pickupZone" className="text-foreground text-xs font-semibold">
                    Pickup Location
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="dropoffZone" className="text-foreground text-xs font-semibold">
                    Drop-off Location
                  </Label>
            ...
            <Card className="border-primary/30 bg-card border-2">
              <CardHeader className="pb-3">
                <Label className="text-foreground text-sm font-semibold">Delivery Timing</Label>
              </CardHeader>
              <CardContent className="space-y-3 p-4 pt-0">
                <RadioGroup
