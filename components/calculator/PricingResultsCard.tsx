      ...
      <CardContent className="space-y-4 p-4 pt-0">
        ...
        <div className="bg-muted flex items-center gap-3 rounded-lg border p-3">
          ...
          <div className="flex-1">
            <p className="text-foreground text-xs font-semibold">Estimated Delivery</p>
        ...
        {/* Breakdown */}
        <div>
          <h4 className="text-foreground mb-3 text-sm font-semibold">Price Breakdown</h4>
        ...
        {/* Info note */}
        <div className="text-muted-foreground bg-muted rounded-lg border p-3 text-xs">
          <p>
